					...
					<div class="wrap-content container" id="container">
						...
						<div class="container-fluid container-fullw bg-white">
							...
							<input type="text" name="doctorspecilization" class="form-control"  placeholder="Enter Doctor Specialization">
														...
														<button type="submit" name="addspec" class="btn btn-o btn-primary">
															Submit
														</button>
													</form>
												</div>
...
?>
	...
	<a href="doctor-specilization.php?id=<?php echo $row['id']?>&deletespace=delete" onClick="return confirm('Are you sure you want to delete?')"class="btn btn-transparent btn-xs tooltips" tooltip-placement="top" tooltip="Remove"><i class="fa fa-times fa fa-white"></i></a>
												</div>
